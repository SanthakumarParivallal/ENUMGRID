...
- [`docs/ACCURACY.md`](docs/ACCURACY.md) — accuracy methodology: CVE-matching precision/recall, version-string + confidence-banded detection, false-positive/negative modes, and limitations

...
[![Tests](https://img.shields.io/badge/tests-1222%20passing-brightgreen.svg)](#-testing--quality-gates)
...
### 🧪 Provably tested
**1222 tests**, and the CLI, all 30 backend modules and the frontend logic layer are
...
| **Evaluation** — `evaluation/test_*.py` | **93** | discovery-benchmark metric math (precision/recall/Jaccard), **multi-run stats** (mean ± 95% CI), arp-scan/netdiscover/masscan baseline parsers, **detection-benchmark scoring** vs a pinned testbed (accuracy-by-confidence, repeated-scan stability), **offline CVE precision·recall** (33-case corpus, Wilson CIs), **AI-copilot eval** (grounding, hallucination detection) |
